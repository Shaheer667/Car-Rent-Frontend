...
const Footer = () => {
  ...
  <div
    className="container-fluid bg-secondary myNavBar py-5 px-sm-3 px-md-5"
    style={{ marginTop: 90 }}
  >
    <div className="row pt-5">
      ...
      <div className="col-lg-3 col-md-6 mb-5">
        ...
        <div className="row mx-n1">
          <div className="col-4 px-1 mb-2">
            <a href="">
              <img className="w-100" src="src/assets/img/gallery-1.jpg" alt="" />
            </a>
          </div>
          <div className="col-4 px-1 mb-2">
            <a href="">
              <img className="w-100" src="src/assets/img/gallery-2.jpg" alt="" />
            </a>
          </div>
          <div className="col-4 px-1 mb-2">
            <a href="">
              <img className="w-100" src="src/assets/img/gallery-3.jpg" alt="" />
            </a>
          </div>
          <div className="col-4 px-1 mb-2">
            <a href="">
              <img className="w-100" src="src/assets/img/gallery-4.jpg" alt="" />
            </a>
          </div>
          <div className="col-4 px-1 mb-2">
            <a href="">
              <img className="w-100" src="src/assets/img/gallery-5.jpg" alt="" />
            </a>
          </div>
          <div className="col-4 px-1 mb-2">
            <a href="">
              <img className="w-100" src="src/assets/img/gallery-6.jpg" alt="" />
            </a>
          </div>
        </div>
      </div>
      <div className="col-lg-3 col-md-6 mb-5">
        ...
        <div className="w-100 mb-3 text-light">
          <div className="input-group">
            <input
              type="text"
              className="form-control bg-dark border-dark text-light white-placeholder"
              style={{ padding: 25 }}
              placeholder="Your Email"
            />
            <div className="input-group-append">
              <button className="btn btn-warning text-uppercase px-3">
                Sign Up
              </button>
            </div>
          </div>
  ...
  <div className="container-fluid bg-dark py-4 px-sm-3 px-md-5">
    <p className="mb-2 text-center text-light">
      © <a href="">caRent.com</a>. All Rights Reserved.
    </p>
    <p className="m-0 text-center text-light">
      Designed by <a href="https://shaheer-portfolio22.web.app">Syed Shaheer Ahmed</a>
    </p>
  </div>
